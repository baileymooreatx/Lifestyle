...
## [Foods to Detoxify the Liver](https://www.youtube.com/watch?v=xcS9x01gB18)
...
1. Promote [autophagy](https://en.wikipedia.org/wiki/Autophagy) through
   prolonged fasting,
   exercise, sleep, keytones, cold therapy, and infrared exposure
2. Fasting lowers inflammation, decrease liver enzymes
3. Take [TUDCA](https://www.amazon.com/dp/B0F4HH894D/) bile salt
4. Trigger phase 1 and phase 2 detoxification (drinking green tea and eating
   broccoli sprouts)
5. Consume milk thistle
6. Take [tocotrienols](https://en.wikipedia.org/wiki/Tocotrienol), a form of vitamin E that breaks up scar tissue
...
1. [Turmeric](./Spices/Turmeric.md) (curcumin)
    ...
    * Stimulates glucose uptake through GLUT4 transporters in muscle and fat
      cells
    * Regulates [AMPK](https://en.wikipedia.org/wiki/AMP-activated_protein_kinase) 
      pathway, like Metformin does
    * Regulates gene expression of glucose transporters in the pancreas which
      stimulates natural insulin secretion
2. Omega-3 Fatty Acids (EPA and DHA)
    * Reduce inflammation by lowering production of pro-inflammatory cytokines
    * Decrease triglycerides
    * Enhance fatty acid oxidation helping reduce accumulation of fat in the
      liver
3. Probiotics and Prebiotics
    * Improve liver markers [liver function tests](https://en.wikipedia.org/wiki/Liver_function_tests)
      including [ALT](https://en.wikipedia.org/wiki/Alanine_transaminase),
...
7. Vitamin E at 800 IU daily increases rate of improvement from non-alcoholic
   [steatohepatitis](https://en.wikipedia.org/wiki/Steatohepatitis)
   (fatty liver disease with inflammation)
8. [Milk Thistle](https://www.youtube.com/watch?v=r0qkWUTc8m4) 600 mg daily is
   effective at reversing early stages, but not in advanced cases
...
1. **Soy Protein Isolates** are chemically isolated from soy using hexane, a
   solvent that is neurotoxic.
   Soy is GMO and contaminated
   with [glyphosate](https://en.wikipedia.org/wiki/Roundup_(herbicide))
2. **Fructose** can only be metabolized by the liver. Commonly sourced from GMO
   crops treated with glyphosate.
3. **Vegetable Fats** (seed oils) are full of Omega-6 fatty acids that create
   inflammation and oxidize easily.
   More GMO and glyphosate.
4. **Whey Protein Powder** is inflammatory and increases negative liver markers.
5. **Maltodextrin** is a synthetic sugar with a higher glycemic index than
   glucose. It promotes fatty liver. Check labels for this in supplements.
...
7. **[Monosodium glutamate (MSG)](https://en.wikipedia.org/wiki/Monosodium_glutamate)**
   is a flavor enhancer that causes us to eat more food and is toxic to the
   liver.  
